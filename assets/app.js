...
function wordDocumentStyles() {
  return `
    ...
    .signature-visual-wrap { width: 300px; height: 132px; min-height: 132px; margin: 0 auto -68px auto; position: relative; overflow: visible; text-align: center; }
...
async function convertSignatureVisualsForWord(root) {
  ...
  for (const wrap of visualWraps) {
    ...
    if (!stampSrc && !ttdSrc) {
      ...
      wrap.setAttribute('style', 'width:300px;height:132px;min-height:132px;margin:0 auto -68px auto;text-align:center;overflow:visible;');
      continue;
    }
    ...
    try {
      ...
      wrap.setAttribute('style', 'width:300px;height:132px;min-height:132px;margin:0 auto -64px auto;text-align:center;overflow:visible;');
    } catch (error) {
...
async function prepareWordHtml(root) {
  ...
  clone.querySelectorAll('.signature-visual-wrap').forEach((node) => {
    node.setAttribute('style', 'width:300px;height:132px;min-height:132px;margin:0 auto -64px auto;position:relative;overflow:visible;');
  });
